...
<head>
    ...
    .barcode-number {
        font-weight: bold;
        margin-top: 10px; /* Adds space between barcode and number */
    }
    </style>
</head>
...
<body>
    ...
    <div class="section">
        ...
        <p><span class="label">Current Certificate Status Date:</span> {{$draft->current_certificate_status_date}}</p>
    ...
    <div class="section">
        ...
        <p><span class="label">County:</span> </p>
    ...
    <p style="font-size: 10px; color: rgb(100, 100, 100)">This is the draft of your Certificate of Sponsorship (COS). Please review the details carefully to ensure accuracy. This document has been generated by Route One Recruitment."

        Let me know if you'd like any further refinements!</p>
</body>
