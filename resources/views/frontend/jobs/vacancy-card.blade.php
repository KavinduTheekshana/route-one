<!-- resources/views/frontend/jobs/partials/vacancy-card.blade.php -->
    ...
    <div class="jbs-grid-layout border">
        ...
        <div class="jbs-grid-emp-head">
            <div class="jbs-grid-emp-thumb">
                <figure>
                    <img src="{{ $vacancy->file_path ? asset('storage/' . $vacancy->file_path) : asset('backend/images/bg/default.png') }}"
                        class="img-fluid" alt="">
                </figure>
            </div>
        </div>
        ...
        <div class="jbs-grid-job-info-wrap">
            <div class="jbs-grid-single-info"><span><i class="fa-solid fa-location-dot"></i>{{ $vacancy->location }}</span></div>
            <div class="jbs-grid-single-info"><span><i
                        class="fa-regular fa-clock"></i>{{ ucfirst(str_replace('-', ' ', $vacancy->job_type)) }}</span></div>
        ...
        <div class="jbs-grid-job-description">
            <p>{{ Str::limit($vacancy->meta_description, 100, '...') }}</p>
        </div>
        ...
        <div class="jbs-grid-job-apply-btns mt-2">
            <div class="jbs-btn-groups">
                ...
                @else
                    <button class="btn-md btn-primary px-4 apply-btn" data-job-id="{{ $vacancy->id }}">Quick Apply</button>
                @endif
            </div>
        </div>
    </div>
