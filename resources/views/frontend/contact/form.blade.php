                ...
                <div class="col-lg-6">
                    <div class="heading5">
                        ...
                        <div class="contact3-box" data-aos="fade-right" data-aos-duration="900">
                            <div class="icon">
                                <img class="contact-icon" src="{{ asset('frontend/img/icons/phone-svgrepo-com.svg') }}"
                                    alt="">
                            </div>
                            <div class="heading4">
                        ...
                        <div class="contact3-box" data-aos="fade-right" data-aos-duration="900">
                            <div class="icon">
                                <img class="contact-icon"
                                    src="{{ asset('frontend/img/icons/whatsapp-svgrepo-com.svg') }}" alt="">
                            </div>
                            <div class="heading4">
                        ...
                        <div class="contact3-box" data-aos="fade-right" data-aos-duration="1100">
                            <div class="icon">
                                <img class="contact-icon"
                                    src="{{ asset('frontend/img/icons/envelope-open-svgrepo-com.svg') }}"
                                    alt="">
                            </div>
                            <div class="heading4">
