...
<div class="row">
                    ...
                    <div class="cs-table cs-style1">
                        ...
                        <div class="cs-invoice_footer">
                            <div class="cs-left_footer cs-mobile_hide" style="color: #777777 !important">
                                ...
                                <p class="cs-m0">ROUTE ONE RECRUITMENT SERVICES LTD TRADING AS ROUTE ONE RECRUITMENT
                                </p>
    ...
    <div class="cs-container col-md-3" style="margin: 0; z-index: 0; max-width: 100%;">
        ...
        <div id="response-message" class="alert alert-success alert-dismissible mt-12" style="display: none;"
            role="alert">
