        ...
        <form
            ...
            <div class="row gy-20">
                <div class="col-xxl-12 col-md-12 col-sm-12">
                    <div class="row g-20">
                        <div class="col-sm-8">
                            <label for="service_name" class="h6 mb-8 fw-semibold font-heading">Service Name <span
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="position-relative">
                                <select name="currency" class="form-select py-9 placeholder-13 text-15">
                                    <option value="GBP"
                                        {{ isset($service) && $service->currency == 'GBP' ? 'selected' : '' }}>GBP
                                    </option>
                        ...
                        <div class="col-12">
                            <div class="editor">
                                ...
                                <textarea placeholder="Service Description" name="description" class="form-control" rows="8">{{ old('description', isset($service) ? $service->description : '') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                @auth
                    @if (Auth::user()->user_type === 'superadmin')
                        <div class="flex-align justify-content-end gap-8">
                            ...
                            <button type="submit"
                                class="btn btn-main rounded-pill py-9">{{ isset($service) ? 'Update Service' : 'Create Service' }}</button>
                        </div>
                    @endif
                @endauth
            </div>
