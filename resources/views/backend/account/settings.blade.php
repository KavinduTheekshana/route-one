        ...
        <div class="setting-profile px-24">
            <div class="flex-between">
                <div class="d-flex align-items-end flex-wrap mb-32 gap-24">
                    ...
                    alt="Profile Image" class="w-120 h-120 rounded-circle border border-white">
                                ...
                                <div class="avatar-upload flex-shrink-0">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="profileImagePreview"
                                            style="background-image: url('{{ auth()->user()->profile_image ? asset('storage/' . auth()->user()->profile_image) : asset('backend/images/thumbs/setting-profile-img.webp') }}');">
                                        </div>
                                    </div>
                                </div>
                                <div
