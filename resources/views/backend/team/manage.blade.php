            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            @if (Auth::id() == $user->id)
                            <a href="{{ route('auth.account') }}" class="btn btn-warning btn-sm"><i class="ph ph-eye"></i></a>
                            @endif

                            @if (Auth::id() !== $user->id)
                            <a href="{{ route('team.settings', $user->id) }}" class="btn btn-warning btn-sm"><i class="ph ph-eye"></i></a>
                                <!-- Delete Button -->
