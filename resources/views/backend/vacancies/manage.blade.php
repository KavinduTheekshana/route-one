...
@section('content')
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        {{-- Breadcrumb  --}}
    @section('page_name', 'Jobs Management')
    ...
    <div class="flex-align gap-8 flex-wrap">
        ...
        <div
            ...
            <a href="{{ route('admin.vacancies.create') }}"
                class="form-control ps-8 pe-20 py-16 border-0 text-inherit rounded-4 text-center">CREATE JOBS</a>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <img src="{{ $vacancy->file_path ? asset('storage/' . $vacancy->file_path) : asset('backend/images/bg/default.png') }}" alt="Profile Image" width="50px"
                    ...
                    <td>
                            ...
                            <a href="{{ route('vacancies.settings', $vacancy->id) }}" class="btn btn-warning btn-sm"><i
                                    class="ph ph-eye"></i></a>
                            <!-- Delete Button -->
                            <button class="btn btn-dark btn-sm" onclick="confirmDelete({{ $vacancy->id }})">
                                <i class="ph ph-trash"></i>
                            </button>

                            <!-- Delete Form -->
                            <form id="delete-form-{{ $vacancy->id }}"
                                action="{{ route('vacancies.destroy', $vacancy->id) }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
