<!-- NIC Fields -->
<div id="cvFields" class="document-fields" style="display:none;">
    <div class="col-12 mt-16">
        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="text" class="form-control py-11" name="document_type" value="curriculum_vitae" hidden>
            <input type="text" class="form-control py-11" name="user_id" value="{{ $user->id }}" hidden>

            <div class="form-group">
                <label>Your Name</label>
                <input type="text" class="form-control" name="file_name" value="{{ $user->name }}"
                ...
                <div class="flex-align gap-10 flex-wrap">
                    ...
                    <div class="upload-section">
                        <p class="text-15 text-gray-500">
                            Please upload a clear document of your CV.
