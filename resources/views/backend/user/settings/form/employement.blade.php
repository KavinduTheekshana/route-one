<!-- NIC Fields -->
<div id="employmentContractsFields" class="document-fields" style="display:none;">
    <div class="col-12 mt-16">
        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="text" class="form-control py-11" name="document_type" value="employment_contracts" hidden>
            <input type="text" class="form-control py-11" name="user_id" value="{{ $user->id }}" hidden>

            <div class="form-group">
                <label>Employment Contracts Providers Name</label>
                <input type="text" class="form-control" name="file_name"
                    placeholder="Enter Your Employment Contracts Providers Name" required>
            </div>
                ...
                <div class="flex-align gap-10 flex-wrap">
                    ...
                    <div class="upload-section">
                        <p class="text-15 text-gray-500">
                            Please upload a clear image of your Employment Contracts.
