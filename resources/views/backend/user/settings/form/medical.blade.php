<!-- NIC Fields -->
<div id="medicalCertificateFields" class="document-fields" style="display:none;">
    <div class="col-12 mt-16">
        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="text" class="form-control py-11" name="document_type" value="medical_certificate" hidden>
            <input type="text" class="form-control py-11" name="user_id" value="{{ $user->id }}" hidden>

            <div class="form-group">
                <label>Medical Certificate Name</label>
                <input type="text" class="form-control" name="file_name"
                    placeholder="Enter Your Medical Certificate Name" required>
            </div>
